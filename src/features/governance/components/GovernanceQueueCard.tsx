    ...
    >
      ...
      <div className="mt-4 flex items-center justify-between gap-2 border-t border-border/60 pt-3">
        <button
          ...
          className="inline-flex items-center gap-1 font-mono text-[11px] text-muted-foreground transition-colors duration-150 hover:text-foreground"
        >
          <ChevronDown
            aria-hidden="true"
        ...
        <div className="flex items-center gap-1.5">
          <button
            ...
            className={cn(
              'inline-flex h-8 items-center gap-1.5 rounded-md border border-success/40 bg-success/10 px-3',
          ...
          >
            ...
            准奏
            <kbd className="rounded border border-success/30 px-1 text-[9px] text-success/70">A</kbd>
          </button>
          <button
            type="button"
            disabled={busy}
            ...
            className={cn(
              'inline-flex h-8 items-center gap-1.5 rounded-md border border-error/30 px-3',
          ...
          >
            ...
            驳回
            <kbd className="rounded border border-error/20 px-1 text-[9px] text-error/60">R</kbd>
          </button>
          <button
            type="button"
            disabled={busy}
            ...
            className={cn(
              'inline-flex h-8 items-center gap-1.5 rounded-md border border-warning/30 px-3',
